    ...
    methods
        ...
        function o = LinePlotReducer(varargin)
            ...
            for k = 1:length(o.h_axes)
                addlistener(o.h_axes(k), 'Units', 'PreSet', @(~,~) o.UnitsPreSet);
                addlistener(o.h_axes(k), 'XLim',  'PostSet', @(~,~) o.RefreshData);
                addlistener(o.h_axes(k), size_cb{:}, @(~,~) o.RefreshData);
            end
            addlistener(o.h_figure, size_cb{:}, @(~,~) o.RefreshData);
