...
n=100;                           % number of points used in the subdivision of the interval [0,1]
...
Er=zeros(n+1);                 %create array Er
for i=1:n+1
    Er(i)=b(x(i))-g_prime(i);       %calculate error
end
plot(x,Er)                 %      plot the error